...
### PROMPT
# This is commented out if using starship prompt [$(tput sgr0)\]
 PS1='[\u@\h \W]\[$(tput sgr0)\]'
...
alias resetReso='killall conky &&
  xrandr -s 1920x1080 &&
  conky -c ~/.config/conky/xmonad/doom-one-01.conkyrc &&
...
### COMMENTED OUT TO ALLOW PS1 - SETTING THE STARSHIP PROMPT ###
